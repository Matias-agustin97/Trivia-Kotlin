...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Assing value to the drawer
        drawerLayout = binding.drawerLayout

        //Steeps required to add a back arror on the app bar, find the nav controller
        val navController = this.findNavController(R.id.myNavHostFragment)

        //, add code to link the navigation controller to the app bar:
        //the third parameter is optional, we use it in this case because we have a nav drawer
        NavigationUI.setupActionBarWithNavController(this,navController,drawerLayout)

        //We set up the drawer
